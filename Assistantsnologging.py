...
class AssistantRouter:
    ...
    def __init__(self, 
        ...
        self.base_prompt_templates = {
            'analytical': "You are an Assistant specializing in analytical thinking. Please provide a complementary comment on the given question from a logical and systematic perspective.",
            'creative': "You are an Assistant specializing in creative thinking. Please provide a complementary comment on the given question from an original and innovative perspective.",
            'practical': "You are an Assistant specializing in a practical approach. Please provide a complementary comment on the given question from a realistic and applicable perspective.",
            'critical': "You are an Assistant specializing in critical thinking. Please provide a complementary comment on the given question from the perspective of finding problems and suggesting improvements.",
            'synthetic': "You are an Assistant specializing in synthetic thinking. Please provide a complementary comment on the given question by integrating various perspectives."
        }
    ...
    def _build_comment_prompt(self,
                            template: str,
                            original_question: str,
                            first_output_text: str, # 입력 파라미터 변경: torch.Tensor -> str [cite: 14]
...
First Answer: {first_output_text}

Related Expert Information: {expert_info}

Based on the information above, please generate a comment from a complementary perspective on the original question.
The comment should be specific and practical, and provide new insights that are distinct from the original answer.
